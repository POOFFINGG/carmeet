...
export const GetMeResponse = zod.object({
  ...
  notifWeek: zod.boolean(),
  notifDay: zod.boolean(),
...
export const GetEventsResponseItem = zod.object({
  ...
  priceParticipants: zod.number().nullish(),
  priceViewers: zod.number().nullish(),
  organizerLink: zod.string().nullish(),
...
export const GetEventApplicationsResponseItem = zod.object({
  ...
  attendanceStatus: zod.enum(["going", "thinking", "not_going"]),
...
export const ApplyToEventBody = zod.object({
  carId: zod.number().nullish(),
  type: zod.enum(["participant", "viewer"]),
  attendanceStatus: zod.enum(["going", "thinking", "not_going"]).optional(),
  comment: zod.string().nullish(),
});
...
export const GetMyCarsResponseItem = zod.object({
  ...
  aiStatus: zod
    ...
    .nullish(),
  silhouetteColor: zod.string().nullish(),
  aiGenerationAttempts: zod.number().nullish(),
